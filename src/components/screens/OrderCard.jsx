...
import DeliveryDetailsModal from "../organisms/DeliveryDetailsModal";
...
const ChoiceHeader = styled.Text`
  margin-bottom: 30px;
`;
...
function OrderSelectionScreen() {
  ...
  return (
    <>
      <MainContainer>
        <Header>
          <Text size="large">Lanespan Pizza & Pub (Emeryville)</Text>
          ...
          <PromotionWrapper>
            <PromotionTextWrapper>
              <Text type="Regular">Promotion applied</Text>
              <Text type="Light">View basket for final discount</Text>
            </PromotionTextWrapper>
          </PromotionWrapper>
        </Header>
        <Container>
